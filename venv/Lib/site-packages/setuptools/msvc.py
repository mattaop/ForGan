...
class SystemInfo:
    ...
    def WindowsSDKExecutablePath(self):
        ...
        # liste all possibles registry paths.yml
        regpaths = []
        if self.vc_ver >= 14.0:
...
class EnvironmentInfo:
    ...
    def _sdk_tools(self):
        """
        Microsoft Windows SDK Tools paths.yml generator
        """
        if self.vc_ver < 15.0:
    ...
    def return_env(self, exists=True):
        ...
        ----------
        exists: bool
            It True, only return existing paths.yml.
        """
        env = dict(
    ...
    def _build_paths(self, name, spec_path_lists, exists):
        """
        Given an environment variable name and specified paths.yml,
        return a pathsep-separated string of paths.yml containing
        unique, extant, directories from those paths.yml and from
        the environment variable. Raise an error if no paths.yml
        are resolved.
        """
