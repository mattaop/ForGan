...
class GAN:
    ...
    def build_discriminator(self):
        ...
        hist = SimpleRNN(64, return_sequences=True)(historic_inp)
        hist = LeakyReLU(alpha=0.2)(hist)

        future = SimpleRNN(64, return_sequences=True)(future_inp)
        future = LeakyReLU(alpha=0.2)(future)

        x = Concatenate(axis=1)([hist, future])
    ...
    def train(self, epochs, batch_size=128, save_interval=50):
        ...
        time_series = generate_sine_data(5000)
...
if __name__ == '__main__':
    gan = GAN()
    gan.train(epochs=200, batch_size=32, save_interval=200)
